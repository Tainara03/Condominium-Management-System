...
var urlParse, MOCK_PLATFORM_LOCATION_CONFIG, _MockPlatformLocation, MockPlatformLocation, _FakeNavigationPlatformLocation, FakeNavigationPlatformLocation, FAKE_NAVIGATION, _SpyLocation, SpyLocation, _LocationState, LocationState, _MockLocationStrategy, MockLocationStrategy, __MockPopStateEvent, _MockPopStateEvent;
var init_testing2 = __esm({
  "node_modules/@angular/common/fesm2022/testing.mjs"() {
    ...
    __name(_MockPlatformLocation, "MockPlatformLocation");
    __publicField(_MockPlatformLocation, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.3.0", ngImport: core_exports, type: _MockPlatformLocation, deps: [{ token: MOCK_PLATFORM_LOCATION_CONFIG, optional: true }], target: FactoryTarget.Injectable }));
    __publicField(_MockPlatformLocation, "\u0275prov", \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.3.0", ngImport: core_exports, type: _MockPlatformLocation }));
    MockPlatformLocation = _MockPlatformLocation;
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.0", ngImport: core_exports, type: MockPlatformLocation, decorators: [{
      type: Injectable
    ...
    __name(_FakeNavigationPlatformLocation, "FakeNavigationPlatformLocation");
    __publicField(_FakeNavigationPlatformLocation, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.3.0", ngImport: core_exports, type: _FakeNavigationPlatformLocation, deps: [], target: FactoryTarget.Injectable }));
    __publicField(_FakeNavigationPlatformLocation, "\u0275prov", \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.3.0", ngImport: core_exports, type: _FakeNavigationPlatformLocation }));
    FakeNavigationPlatformLocation = _FakeNavigationPlatformLocation;
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.0", ngImport: core_exports, type: FakeNavigationPlatformLocation, decorators: [{
      type: Injectable
    ...
    __name(_SpyLocation, "SpyLocation");
    __publicField(_SpyLocation, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.3.0", ngImport: core_exports, type: _SpyLocation, deps: [], target: FactoryTarget.Injectable }));
    __publicField(_SpyLocation, "\u0275prov", \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.3.0", ngImport: core_exports, type: _SpyLocation }));
    SpyLocation = _SpyLocation;
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.0", ngImport: core_exports, type: SpyLocation, decorators: [{
      type: Injectable
    }] });
    _LocationState = class _LocationState {
      path;
      query;
      state;
    ...
    __name(_LocationState, "LocationState");
    ...
    __name(_MockLocationStrategy, "MockLocationStrategy");
    __publicField(_MockLocationStrategy, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.3.0", ngImport: core_exports, type: _MockLocationStrategy, deps: [], target: FactoryTarget.Injectable }));
    __publicField(_MockLocationStrategy, "\u0275prov", \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.3.0", ngImport: core_exports, type: _MockLocationStrategy }));
    MockLocationStrategy = _MockLocationStrategy;
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.0", ngImport: core_exports, type: MockLocationStrategy, decorators: [{
      type: Injectable
    }], ctorParameters: /* @__PURE__ */ __name(() => [], "ctorParameters") });
    __MockPopStateEvent = class __MockPopStateEvent {
      newUrl;
      pop = true;
      type = "popstate";
      constructor(newUrl) {
    ...
    __name(__MockPopStateEvent, "_MockPopStateEvent");
    _MockPopStateEvent = __MockPopStateEvent;
    __name(provideLocationMocks, "provideLocationMocks");
  }
});
...
@angular/common/fesm2022/testing.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-EVNDHHUL.js.map
